...
import { BASE_URL } from "./creatioClient.js";
...
/**
 * Opens a browser window at the Creatio base URL and waits for the user to
 * finish logging in, detected by the .ASPXAUTH cookie appearing in the jar.
 * Resolves with the three cookies Settings otherwise asks for by hand.
 */
